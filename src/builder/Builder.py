...
class Builder:
    def execute(self):
        ...
        ScreensCompressor().execute(is128K, screenExists("intro"), screenExists("gameover"), screenExists("gamemap"), screenExists("credits"), screenExists("redefine"), screenExists("instructions"))
