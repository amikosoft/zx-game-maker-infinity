...
class ChartGenerator:
    def execute(self, sizes: Sizes, is128k):
        enemiesSize = sizes.ENEMIES_DATA + sizes.ENEMIES_IN_SCREEN_OFFSETS_DATA + sizes.ENEMIES_PER_SCREEN_DATA + sizes.ENEMIES_PER_SCREEN_INITIAL_DATA + sizes.DECOMPRESSED_ENEMIES_SCREEN_DATA + sizes.TEXTS_COORD_DATA
