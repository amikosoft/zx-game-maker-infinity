...
class ChartGenerator:
    def execute(self, sizes: Sizes, is128k, adventureTexts, musicEnabled, breakableTiles, attrsEnabled):
        ...
        if is128k:
            ...
            paramsMap4 = "Title-Screen:" + str(sizes.TITLE_SCREEN) + ",End-Screen:" + str(sizes.ENDING_SCREEN) + ",HUD:" + str(sizes.HUD_SCREEN) + ",Intro-Screen:" + str(sizes.INTRO_SCREEN) + ",GameOver-Screen:" + str(sizes.GAMEOVER_SCREEN) + ",GameMap-Screen:" + str(sizes.GAMEMAP_SCREEN) + " memory-bank-4.png"
